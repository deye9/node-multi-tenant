...
cli.tenancy.install = async() => {
  ...
  await cli.tenancy.executeCommand(`cp node_modules/node_multi_tenant/dist/migrations/*.js ${migrationPath}/`);

  console.log("Copying tenancy model files to the models folder");
  await cli.tenancy.executeCommand(`cp node_modules/node_multi_tenant/dist/models/*.js ${modelsPath}/`);
...
// cli.tenancy.executeCommand = (cliCommand, displayline=true) => {
